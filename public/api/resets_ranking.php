...
/**
 * Ranking de Resets
 * Gera JSON com top 100 personagens por número de resets
 */
...
try {
    ...
    // Query para buscar top resets (MySQL syntax)
    $sql = "SELECT
                c.Name as name,
                c.cLevel as level,
                c.Resets as resets,
    ...
    file_put_contents(__DIR__ . '/data/resets_ranking.json', json_encode($json_data, JSON_PRETTY_PRINT));
    
    echo "Resets ranking updated: " . count($ranking) . " players\n";
